export function getSwipePageDelta(start, end, options = {}) {
...
export function getNextPageNumber(currentPage, delta, options = {}) {
...
export function selectReaderPage(pages, requestedPage) {
